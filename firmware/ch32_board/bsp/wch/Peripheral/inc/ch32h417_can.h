...
*******************************************************************************/
#ifndef __CH32H417_CAN_H
#define __CH32H417_CAN_H
...
typedef struct
{
    ...
    uint8_t CAN_FilterNumber; /* Specifies the filter which will be initialized. It ranges from 0 to 27. */
...
/* CAN_filter_scale */
#define CAN_FilterScale_16bit               ((uint8_t)0x00) /* Two 16-bit filter */
...
#define CAN_FIFO1                           ((uint8_t)0x01) /* CAN FIFO 0 used to receive */
