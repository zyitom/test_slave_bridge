 ...
 * @fn      ADC_TO_DFSDM_Cmd
 *
 * @brief   Enables or disables the ADCx sample data t0 DFSDM.
 *
 * @param   ADCx - where x can be 1 or 2 to select the ADC peripheral.
 *          NewState - ENABLE or DISABLE.
 *
 ...
 *
 * @brief   Enables or disables the specified ADC low power mode peripheral.
 *
 * @param   ADCx - where x can be 1 or 2 to select the ADC peripheral.
 *          NewState - ENABLE or DISABLE.
 *
 ...
 *
 * @brief   Enables or disables the specified ADC hardware Calibration.
 *
 * @param   ADCx - where x can be 1 or 2 to select the ADC peripheral.
 *          NewState - ENABLE or DISABLE.
 *
