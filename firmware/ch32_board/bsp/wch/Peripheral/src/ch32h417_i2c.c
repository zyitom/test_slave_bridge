 ...
 *        reset values.
 *
 * @param   I2Cx - where x can be (1~4) to select the I2C peripheral.
 *
 * @return  none
 */
void I2C_DeInit(I2C_TypeDef *I2Cx)
{
    if(I2Cx == I2C1)
    {
        RCC_HB1PeriphResetCmd(RCC_HB1Periph_I2C1, ENABLE);
        RCC_HB1PeriphResetCmd(RCC_HB1Periph_I2C1, DISABLE);
    }
    else if(I2Cx == I2C2)
    {
        RCC_HB1PeriphResetCmd(RCC_HB1Periph_I2C2, ENABLE);
        RCC_HB1PeriphResetCmd(RCC_HB1Periph_I2C2, DISABLE);
    }
    else if(I2Cx == I2C3)
    {
        RCC_HB1PeriphResetCmd(RCC_HB1Periph_I2C3, ENABLE);
        RCC_HB1PeriphResetCmd(RCC_HB1Periph_I2C3, DISABLE);
    }
    else if(I2Cx == I2C4)
    {
        RCC_HB2PeriphResetCmd(RCC_HB2Periph_I2C4, ENABLE);
        RCC_HB2PeriphResetCmd(RCC_HB2Periph_I2C4, DISABLE);
    }
}
...
void I2C_Init(I2C_TypeDef *I2Cx, I2C_InitTypeDef *I2C_InitStruct)
{
    ...
    pclk1 = rcc_clocks.HCLK_Frequency;
