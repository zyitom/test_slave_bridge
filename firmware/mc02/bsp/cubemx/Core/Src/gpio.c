...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, Power_OUT2_EN_Pin|Power_OUT1_EN_Pin|EXT_SPI3_CLK_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, Power_5V_EN_Pin|CS1_ACCEL_Pin|CS1_GYRO_Pin|DCMI_PWDN_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : Power_OUT2_EN_Pin Power_OUT1_EN_Pin EXT_SPI3_CLK_Pin */
  GPIO_InitStruct.Pin = Power_OUT2_EN_Pin|Power_OUT1_EN_Pin|EXT_SPI3_CLK_Pin;
  ...
  /*Configure GPIO pin : EXT_SPI3_MISO_Pin */
  GPIO_InitStruct.Pin = EXT_SPI3_MISO_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(EXT_SPI3_MISO_GPIO_Port, &GPIO_InitStruct);
