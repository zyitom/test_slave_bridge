...
#define UC_SET_ECAT_LED                           0 //This define was already evaluated by ET9300 Project Handler(V. 1.5.3.0)!
#endif
...
#define ESC_SUPPORT_ECAT_LED                      1 //This define was already evaluated by ET9300 Project Handler(V. 1.5.3.0)!
#endif
...
#define ESC_EEPROM_EMULATION                      1 //This define was already evaluated by ET9300 Project Handler(V. 1.5.3.0)!
#endif
...
#define MBX_STRUCT_PACKED_START                   ATTR_PACKED
#endif
...
#define OBJ_STRUCT_PACKED_START                   ATTR_PACKED
#endif
...
#define MAX_PD_INPUT_SIZE                         0x40 //This define was already evaluated by ET9300 Project Handler(V. 1.5.3.0)!
#endif
...
#define MAX_PD_OUTPUT_SIZE                        0x40 //This define was already evaluated by ET9300 Project Handler(V. 1.5.3.0)!
#endif
...
#define MIN_PD_CYCLE_TIME                         0x79E0
#endif
