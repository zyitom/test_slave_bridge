...
#define RMCS_MAP_16(index, first)                                                             \
    RMCS_MAP_4(index, first), RMCS_MAP_4(index, (first) + 4),                                 \
        RMCS_MAP_4(index, (first) + 8), RMCS_MAP_4(index, (first) + 12)
...
OBJCONST TSDOINFOENTRYDESC OBJMEM asEntryDesc0x1600[] = {
    {DEFTYPE_UNSIGNED8, 0x8, ACCESS_READ}, RMCS_DESC_64, RMCS_DESC_16, RMCS_DESC_8
};
